...
// Quand `VITE_INTENT_ENABLED` n'est pas explicitement 'true', on force
// `skipIntent=true` côté backend pour que le pipeline tourne en mode
// exactement identique à avant (non-regression garantie).
// Mettre la variable à 'true' sur Vercel active l'écran intention.
