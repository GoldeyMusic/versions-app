...
export default function MockupStyles() {
  ...
  */
  ...
  /* ═══════════════════════════════════════════════════════════ */
  /* INTENTION ARTISTIQUE — écran intermédiaire + panneau fiche  */
  /* ═══════════════════════════════════════════════════════════ */
  ...
  .intent-screen-compact { max-width: 820px; padding: 40px 28px; }

  .intent-head { margin-bottom: 32px; }
  .intent-kicker {
  ...
  .intent-subtitle {
    font-size: 14px; line-height: 1.6; color: var(--soft);
  ...
  @media (max-width: 900px) { .intent-grid { grid-template-columns: 1fr; gap: 28px; } }
  .intent-col-main { min-width: 0; display: flex; flex-direction: column; gap: 22px; }
  .intent-col-side { display: flex; flex-direction: column; gap: 24px; }
  ...
  .intent-perception-lead {
    font-family: 'Cormorant Garamond', serif; font-style: italic;
    font-size: 17px; line-height: 1.5; color: var(--soft);
    margin-bottom: 12px;
  }
  ...
  /* Textarea */
  .intent-textarea-wrap { position: relative; }
  .intent-textarea {
    width: 100%; box-sizing: border-box;
  ...
  .intent-textarea:focus { outline: none; border-color: var(--amber); }
  .intent-textarea::placeholder { color: var(--muted2); font-style: italic; }
  .intent-char-count {
    font-family: var(--mono); font-size: 10px; color: var(--muted2);
  ...
  /* Scope (V2+) */
  .intent-scope { margin-top: 18px; }
  .intent-scope-label {
    font-family: var(--mono); font-size: 10px; letter-spacing: 2px;
    color: var(--muted); text-transform: uppercase; margin-bottom: 8px;
  }
  .intent-seg {
    display: inline-flex; background: var(--s1);
    border: 1px solid var(--border); border-radius: 8px;
    padding: 3px; gap: 2px;
  }
  .intent-seg-btn {
  ...
  .intent-seg-btn.on {
    background: var(--amber); color: var(--black); font-weight: 500;
  }
  ...
  .intent-btn-primary:hover:not(:disabled) { background: #f7be6f; }
  .intent-btn-primary:disabled { opacity: .4; cursor: not-allowed; }
  .intent-btn-ghost {
  ...
  .intent-btn-ghost:hover { color: var(--soft); }

  /* Exemples (colonne de droite V1) */
  .intent-examples-title {
    font-family: var(--mono); font-size: 10px; letter-spacing: 2px;
    color: var(--muted); text-transform: uppercase; margin-bottom: 12px;
  }
  .intent-examples { display: flex; flex-direction: column; gap: 10px; }
  .intent-example {
  ...
  .intent-example:hover {
    border-color: var(--amber-dim); background: var(--s2);
  }
  ...
  .intent-pipeline-step.done { color: var(--green); }
  .intent-pipeline-step.done::before { background: var(--green); border-color: var(--green); }
  .intent-pipeline-step.active { color: var(--amber); }
  ...
  /* ═══════════════════════════════════════════════════════════ */
  /* Panneau "Intention déclarée" dans la fiche                  */
  /* ═══════════════════════════════════════════════════════════ */
  .intent-fiche-panel {
    margin: 14px 0 4px;
    padding: 14px 18px;
  ...
  .intent-fiche-note {
    margin-top: 8px;
    font-family: var(--body); font-size: 11px; line-height: 1.5;
    color: var(--muted);
  }
`}</style>
    </>
