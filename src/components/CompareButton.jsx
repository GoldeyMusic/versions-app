            ...
            {others.map((v) => (
              <button
                ...
                style={{
                  ...
                  fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: '#c5c5c7',
                }}
      ...
      {(loading || result || error) && createPortal((
        ...
        >
          <div style={{
            ...
            >×</button>
            {loading && (
              <div style={{ padding: '40px 0', textAlign: 'center', color: '#7c7c80', fontFamily: "'DM Sans', sans-serif", fontSize: 16, letterSpacing: 1.5 }}>
  ...
  return (
    <div>
      ...
      {(!items || items.length === 0) && (
        <div style={{ color: '#555', fontSize: 16, fontStyle: 'italic' }}>—</div>
      )}
      {(items || []).map((it, i) => (
