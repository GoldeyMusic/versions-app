...
const STRINGS = {
  fr: {
    ...
    addModal: {
      ...
      uploadTypeAutoHint: "À cocher si tu n'es pas sûr — c'est le défaut. Ton titre est évalué comme un mix en cours, sans exiger les niveaux d'un master fini.",
  ...
  en: {
    ...
    addModal: {
      ...
      uploadTypeAutoHint: "Pick this if you're not sure — it's the default. Your track is evaluated as an in-progress mix, without requiring finished-master levels.",
