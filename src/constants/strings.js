...
const STRINGS = {
  fr: {
    ...
    home: {
      ...
      shareTrack: "Partager ce titre",
      projectAvgScore: "Score moyen",
      searchPlaceholder: "Rechercher un projet, un titre…",
      searchNoResults: "Aucun résultat",
      searchProjectsLabel: "Projets",
      searchTracksLabel: "Titres",
      searchHint: "↑↓ naviguer · Entrée ouvrir · Échap fermer",
    ...
    input: {
      ...
      dropFormats: "WAV (recommandé) · MP3 · FLAC — 70 Mo max",
      vocalSung: "Chanté",
    ...
    loading: {
      ...
      cancel: "Annuler l'analyse",
      errorDuplicate: "Fichier identique à la version \"{name}\" déjà uploadée pour ce titre.",
      errorDuplicateOtherTrack: "Tu as déjà analysé ce fichier dans le titre \"{track}\" (version \"{name}\") avec les mêmes paramètres.",
      duplicateModalTitle: "Analyse déjà existante",
      duplicateModalSeeExisting: "Voir l'analyse existante",
      duplicateModalUploadAnyway: "Uploader quand même",
    ...
    fiche: {
      ...
      intentEmpty: "Non renseignée",
      intentEdit: "Modifier",
      intentAdd: "Ajouter une intention artistique",
      intentSave: "Enregistrer",
      intentSaving: "Enregistrement…",
      intentCancel: "Annuler",
      intentPlaceholder: "Décris en une ou deux phrases l’intention artistique de ce titre (ambiance, références, ce que tu cherches à transmettre)…",
    ...
    addModal: {
      ...
      uploadDropFormats: "WAV (recommandé) · MP3 · FLAC · 70 Mo max",
      uploadTitleLabel: "Titre",
      uploadTitlePlaceholder: "Nom du morceau",
      uploadVersionLabel: "Nomme ta version",
      ...
      uploadTypeNoHint: "Mix en cours — c'est le défaut. Ton titre est évalué sans exiger les niveaux d'un master fini. Même avec un limiteur ou un plugin de mastering posé sur le bus master pour l'écoute, laisse Non tant que tu fignoles.",
      ...
      uploadBpmLabel: "BPM",
      uploadBpmHint: "Optionnel — laisse vide pour détection automatique.",
    ...
    errors: {
      ...
      fileTooBig: "Fichier trop volumineux (70 Mo max).",
      fileType: "Format non supporté. Utilise WAV, MP3 ou FLAC.",
    ...
    pricing: {
      ...
      subsPluginPerk: "Et dans le plugin : écoute express + chat IA en illimité.",
    ...
    landing: {
      ...
      // Version courte pour le badge coin de bouton (grammaire .lp-new-badge)
      freeFirstBadgeShort: "1 analyse offerte",
      ...
      diffCard5Title: "Des fiches qui se travaillent à plusieurs",
      diffCard5Body: "Partagez une fiche d'analyse à votre réalisateur, votre label ou un autre artiste : chacun son rôle, chacun ses commentaires. Les retours restent posés au bon endroit — sur l'analyse, pas éparpillés dans des messages.",
      diffCard6Title: "En ligne et au cœur de votre DAW",
      diffCard6Body: "L'analyse complète sur le site, et un plugin qui vit dans votre session : metering, conseils et écoute express pendant que vous produisez. Le même assistant, du premier réglage à la version finale.",
      ...
      // ── Plugin DAW — intégration home (topbar + CTA hero + section) ──
      // Faits sourcés depuis versions-plugin/CLAUDE.md (2026-07) :
      // AU + VST3, macOS + Windows, express-only (l'analyse complète vit
      // sur le site), gratuit = metering illimité + 5 écoutes express/mois
      // + 15 messages chat/jour, illimité avec les abos Indie/Pro.
      pluginNav: "Plugin",
      pluginNewBadge: "Nouveau",
      ctaPlugin: "Découvrir le plugin",
      plugEyebrow: "LE PLUGIN",
      plugTitleStart: "Votre assistant,",
      plugTitleEm: "directement dans votre session.",
      plugLede: "Metering pro gratuit et illimité, chat qui entend votre session, verdict d'écoute en 30 secondes. Et pour la fiche complète, versions.studio vous attend.",
      plugVideoNote: "Vidéo de démo",
      plugPoint1Title: "Metering temps réel, gratuit et illimité",
      plugPoint1Body: "LUFS, true peak, spectre, image stéréo — pendant que vous mixez, 100 % local.",
      plugPoint2Title: "Un assistant IA qui entend votre mix",
      plugPoint2Body: "Posez une question : la réponse s'appuie sur vos mesures en direct et sur les plugins que vous possédez — pas sur des généralités.",
      plugPoint3Title: "Une instance par piste, une vue d'ensemble",
      plugPoint3Body: "Le plugin voit toute votre session : détection de masquage, équilibres entre pistes, et des conseils qui tiennent compte de tout ce qui joue.",
    ...
    /* ─────────────────────── PAGE PLUGIN (/plugin) ───────────────────
     * Page dédiée au plugin DAW. Même grammaire éditoriale que la
     * landing (vouvoiement, em ambre, mono uppercase pour les eyebrows).
     */
    pluginPage: {
      topbarHome: "Accueil",
      topbarCurrent: "Plugin",
      topbarBackAria: "Retour à l'accueil",
      heroChip1: "-14.2 LUFS",
      heroChip2: "SCORE 82/100",
      heroChip3: "TRUE PEAK -1.1 dB",
      heroChip4: "SESSION · 5 PISTES",
      heroTitleLine1: "Votre assistant,",
      heroTitleLine2Before: "dans ",
      heroTitleLine2Em: "votre DAW",
      heroTitleLine2After: ".",
      taglineBefore: "écoute, ",
      taglineEm: "comprend",
      taglineAfter: ", guide — pendant que vous mixez.",
      heroSub: "Le plugin VERSiONS vit dans votre session : il mesure en temps réel, répond à vos questions en s'appuyant sur ce qu'il entend, et vous donne un verdict d'écoute en 30 secondes — sans rien exporter.",
      chipFree: "GRATUIT",
      ctaMac: "Télécharger pour Mac",
      ctaWin: "Télécharger pour Windows",
      ctaWinSoon: "Windows — bientôt disponible",
      ctaComingSoon: "Lien de téléchargement à venir",
      ctaAuthNote: "Téléchargement avec un compte gratuit — le plugin vous demandera de vous connecter à l'ouverture.",
      videoNote: "Vidéo de démo",
      howEyebrow: "COMMENT ÇA MARCHE",
      howTitleStart: "Trois gestes, ",
      howTitleEm: "zéro export.",
      step1Title: "Posez-le sur vos pistes, vos bus",
      step1Body: "Master, basse, voix, etc. — une instance par piste. Le metering démarre tout seul, et les instances se voient entre elles.",
      step2Title: "Demandez ce que vous voulez",
      step2Body: "« Ma basse masque mon kick ? » Le plugin lit toute votre session et vous répond sur votre mix, pas en théorie.",
      step3Title: "Lancez une écoute express",
      step3Body: "30 secondes d'écoute, un verdict clair dans le chat. Et pour la fiche complète, votre compte versions.studio est déjà relié.",
      featEyebrow: "CE QU'IL SAIT FAIRE",
      featTitleStart: "Il ne mixe pas à votre place. ",
      featTitleEm: "Il vous apprend à mixer.",
      feat1Tag: "Gratuit · illimité",
      feat1Title: "Metering temps réel",
      feat1Body: "LUFS, true peak, plage dynamique, spectre de niveau pro, image stéréo avec corrélation et largeur. Les chiffres qui comptent, lisibles d'un coup d'œil, 100 % local.",
      feat2Tag: "Inclus",
      feat2Title: "Session View",
      feat2Body: "Une instance par piste, et le plugin voit toute votre console : détection de masquage calibrée, spectres superposés, conseils inter-pistes. Personne d'autre ne le fait en dialogue.",
      feat3Tag: "15 messages/jour offerts",
      feat3Title: "Chat en contexte",
      feat3Body: "Vous demandez, il répond — en s'appuyant sur vos mesures en direct et sur ce qui joue dans votre session. En français ou en anglais.",
      feat4Tag: "5/mois offertes",
      feat4Title: "Écoute express",
      feat4Body: "Le plugin écoute 30 secondes de votre mix — ou d'une seule piste — et vous rend un verdict clair dans le chat. Illimitée avec les abonnements Indie et Pro.",
      feat5Tag: "Inclus",
      feat5Title: "Il connaît votre arsenal",
      feat5Body: "Le plugin scanne les plugins installés sur votre ordinateur, et vous choisissez lesquels comptent. Les recommandations citent vos EQ et vos compresseurs — pas des outils que vous n'avez pas.",
      feat6Tag: "Inclus",
      feat6Title: "Calibré sur votre setup",
      feat6Body: "Votre DAW favori, votre système d'écoute — casque ou enceintes de monitoring —, votre niveau : renseignez vos réglages une fois, et chaque réponse en tient compte.",
      featNote: "Abonné Indie ou Pro ? Écoute express et chat en illimité dans le plugin. Et l'analyse complète — score, diagnostic élément par élément, verdict de sortie — vit sur versions.studio, reliée à votre compte.",
      footerQuoteStart: "Votre musique. ",
      footerQuoteEm: "Votre vision.",
      footerQuoteEnd: "Notre accompagnement — jusque dans votre DAW.",
      ctaFooterDownload: "Télécharger le plugin",
  ...
  en: {
    ...
    home: {
      ...
      share: "Share / Members",
      shareTrack: "Share this track",
      projectAvgScore: "Avg. score",
      searchPlaceholder: "Search a project, a track…",
    ...
    input: {
      ...
      dropFormats: "WAV (recommended) · MP3 · FLAC — 70 MB max",
      vocalSung: "Vocal",
      vocalInstrumental: "Instrumental",
    ...
    loading: {
      ...
      cancel: "Cancel analysis",
      errorDuplicate: "File identical to version \"{name}\" already uploaded for this track.",
      errorDuplicateOtherTrack: "You've already analyzed this file in the track \"{track}\" (version \"{name}\") with the same parameters.",
      duplicateModalTitle: "Analysis already exists",
      duplicateModalSeeExisting: "View existing analysis",
      duplicateModalUploadAnyway: "Upload anyway",
    ...
    fiche: {
      ...
      intentEmpty: "Not set",
      intentEdit: "Edit",
      intentAdd: "Add an artistic intent",
      intentSave: "Save",
      intentSaving: "Saving…",
      intentCancel: "Cancel",
      intentPlaceholder: "Describe in a sentence or two the artistic intent of this track (mood, references, what you want it to convey)…",
    ...
    addModal: {
      ...
      uploadDropFormats: "WAV (recommended) · MP3 · FLAC · 70 MB max",
      uploadTitleLabel: "Title",
      uploadTitlePlaceholder: "Track name",
      uploadVersionLabel: "Name your version",
      uploadVersionPlaceholder: "v1, rough, master…",
      ...
      uploadTypeNoHint: "Mix in progress — it's the default. Your track is evaluated without requiring finished-master levels. Even with a limiter or a mastering plugin on the master bus for monitoring, keep No while you're still tweaking.",
      ...
      uploadBpmLabel: "BPM",
      uploadBpmHint: "Optional — leave empty for auto detection.",
    ...
    errors: {
      ...
      fileTooBig: "File too large (70 MB max).",
      fileType: "Unsupported format. Use WAV, MP3 or FLAC.",
    ...
    pricing: {
      ...
      subsPluginPerk: "And in the plugin: unlimited express listening + AI chat.",
      subAllowanceLine1: "analyses",
    ...
    landing: {
      ...
      freeFirstBadgeShort: "1 free analysis",
      ...
      diffCard5Title: "Reports you work on together",
      diffCard5Body: "Share an analysis report with your producer, your label or another artist: each with their role, each with their comments. Feedback stays where it belongs — on the analysis, not scattered across messages.",
      diffCard6Title: "Online and at the heart of your DAW",
      diffCard6Body: "The full analysis on the site, and a plugin that lives in your session: metering, advice and express listens while you produce. The same assistant, from the first tweak to the final version.",
      ...
      // ── DAW plugin — home integration (topbar + hero CTA + section) ──
      pluginNav: "Plugin",
      pluginNewBadge: "New",
      ctaPlugin: "Discover the plugin",
      plugEyebrow: "THE PLUGIN",
      plugTitleStart: "Your assistant,",
      plugTitleEm: "right inside your session.",
      plugLede: "Free unlimited pro metering, a chat that hears your session, a listening verdict in 30 seconds. And for the full report, versions.studio is waiting.",
      plugVideoNote: "Demo video",
      plugPoint1Title: "Real-time metering, free and unlimited",
      plugPoint1Body: "LUFS, true peak, spectrum, stereo image — while you mix, 100% local.",
      plugPoint2Title: "An AI assistant that hears your mix",
      plugPoint2Body: "Ask a question: the answer draws on your live measurements and the plugins you actually own — not on generalities.",
      plugPoint3Title: "One instance per track, one overview",
      plugPoint3Body: "The plugin sees your whole session: masking detection, balance between tracks, and advice that takes everything playing into account.",
    ...
    pluginPage: {
      ...
      heroChip2: "SCORE 82/100",
      heroChip3: "TRUE PEAK -1.1 dB",
      heroChip4: "SESSION · 5 TRACKS",
      heroTitleLine1: "Your assistant,",
      heroTitleLine2Before: "inside ",
      heroTitleLine2Em: "your DAW",
      heroTitleLine2After: ".",
      taglineBefore: "listens, ",
      taglineEm: "understands",
      taglineAfter: ", guides — while you mix.",
      heroSub: "The VERSiONS plugin lives in your session: it measures in real time, answers your questions based on what it hears, and gives you a listening verdict in 30 seconds — without exporting anything.",
      chipFree: "FREE",
      ctaMac: "Download for Mac",
      ctaWin: "Download for Windows",
      ctaWinSoon: "Windows — coming soon",
      ctaComingSoon: "Download link coming soon",
      ctaAuthNote: "Download with a free account — the plugin asks you to sign in when it opens anyway.",
      videoNote: "Demo video",
      howEyebrow: "HOW IT WORKS",
      howTitleStart: "Three moves, ",
      howTitleEm: "zero export.",
      step1Title: "Drop it on your tracks and buses",
      step1Body: "Master, bass, vocals, etc. — one instance per track. Metering starts on its own, and the instances see each other.",
      step2Title: "Ask whatever you want",
      step2Body: "\"Is my bass masking my kick?\" The plugin reads your whole session and answers about your mix, not in theory.",
      step3Title: "Run an express listen",
      step3Body: "30 seconds of listening, a clear verdict in the chat. And for the full report, your versions.studio account is already linked.",
      featEyebrow: "WHAT IT CAN DO",
      featTitleStart: "It doesn't mix for you. ",
      featTitleEm: "It teaches you how to mix.",
      feat1Tag: "Free · unlimited",
      feat1Title: "Real-time metering",
      feat1Body: "LUFS, true peak, dynamic range, pro-grade spectrum, stereo image with correlation and width. The numbers that matter, readable at a glance, 100% local.",
      feat2Tag: "Included",
      feat2Title: "Session View",
      feat2Body: "One instance per track, and the plugin sees your whole console: calibrated masking detection, overlaid spectra, cross-track advice. Nobody else does this in dialogue.",
      feat3Tag: "15 messages/day free",
      feat3Title: "Chat in context",
      feat3Body: "You ask, it answers — drawing on your live measurements and what's playing in your session. In French or English.",
      feat4Tag: "5/month free",
      feat4Title: "Express listen",
      feat4Body: "The plugin listens to 30 seconds of your mix — or a single track — and gives you a clear verdict in the chat. Unlimited with the Indie and Pro subscriptions.",
      feat5Tag: "Included",
      feat5Title: "It knows your arsenal",
      feat5Body: "The plugin scans the plugins installed on your computer, and you choose which ones count. Recommendations name your EQs and compressors — not tools you don't own.",
      feat6Tag: "Included",
      feat6Title: "Calibrated to your setup",
      feat6Body: "Your favorite DAW, your listening setup — headphones or studio monitors —, your level: set your preferences once, and every answer takes them into account.",
      featNote: "Indie or Pro subscriber? Unlimited express listens and chat in the plugin. And the full analysis — score, element-by-element diagnosis, release verdict — lives on versions.studio, linked to your account.",
      footerQuoteStart: "Your music. ",
      footerQuoteEm: "Your vision.",
      footerQuoteEnd: "Our guidance — all the way into your DAW.",
      ctaFooterDownload: "Download the plugin",
